...
public sealed class YtDlpService
{
        ...
        IProgress<string> log, IProgress<(double Percent, string Status)> progress, CancellationToken token)
    {
        ...
        {
            // Download the best source up to the selected resolution first. The final file is
            // transcoded afterwards to a Premiere Pro friendly MP4 (H.264 + AAC).
        ...
        if (outputFormat is not ("mp3" or "m4a"))
        {
