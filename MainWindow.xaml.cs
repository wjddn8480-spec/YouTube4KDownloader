...
public partial class MainWindow : Window
{
    ...
    {
        if (AutoClipboardCheckBox.IsChecked != true) return;
        string text;
        try
        {
    ...
    protected override void OnClosed(EventArgs e) { _clipboardTimer.Stop(); SaveSettings(); _store.SaveHistory(_history); _cts?.Cancel(); _downloader.Cancel(); base.OnClosed(e); }
}
